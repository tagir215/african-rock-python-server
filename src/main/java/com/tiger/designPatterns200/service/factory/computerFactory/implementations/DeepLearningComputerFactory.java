...
public class DeepLearningComputerFactory extends AbstractComputerFactory{
    ...
    public DeepLearningComputerFactory(ComponentSelector selector) {
    	super(selector);
