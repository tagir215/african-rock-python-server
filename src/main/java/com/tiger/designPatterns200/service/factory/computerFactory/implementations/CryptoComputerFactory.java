...
public class CryptoComputerFactory extends AbstractComputerFactory{
    ...
    public CryptoComputerFactory(ComponentSelector selector) {
    	super(selector);
		...
		info.setX_powerUnit(0.2f);
		info.setX_ram(0.05f);
		info.setX_storage(0.05f);
	}
