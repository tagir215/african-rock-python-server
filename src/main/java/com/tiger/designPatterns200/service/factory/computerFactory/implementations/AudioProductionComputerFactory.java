...
public class AudioProductionComputerFactory extends AbstractComputerFactory{
    ...
    public AudioProductionComputerFactory(ComponentSelector selector) {
    	super(selector);
