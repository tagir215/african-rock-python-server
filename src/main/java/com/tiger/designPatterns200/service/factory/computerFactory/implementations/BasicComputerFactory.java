...
public class BasicComputerFactory extends AbstractComputerFactory {
	private ComputerInfo info;
	protected final int BUDGET_MAX = 500;
	protected final int MIDTIER_MAX = 1000;
	protected final int HIGHEND_MAX = 4000;
	protected final int ENTHUSIAST_MAX = 10000;
	
    public BasicComputerFactory(ComponentSelector selector) {
    	super(selector);
