...
public class VirtualRealityComputerFactory extends AbstractComputerFactory {
    ...
    public VirtualRealityComputerFactory(ComponentSelector selector) {
    	super(selector);
    	info = new ComputerInfo();
		info.setX_case(0.1f);
		info.setX_cooler(0.1f);
		info.setX_cpu(0.3f);
		info.setX_gpu(0.4f);
